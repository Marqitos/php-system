...
class PerlCompatible {
    ...
    public function grep(array $array, boolean $invert = false) {
     ...
     */
    public function match(string $subject, boolean $offsetCapture = false, int $offset = 0) : array {
        $matches = []
    ...
    public function match_all(string $subject, int $flags = PREG_PATTERN_ORDER, int $offset = 0) : array {
        $matches = []
